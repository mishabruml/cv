...
\item Full stack software engineering in JavaScript, NodeJS, React. Experience designing, building and maintaining entire software systems/platforms including servers, API/backend, databases, frontend, job queue systems, unit and integration testing
\item Cloud computing and infrastructure (AWS); ElasticBeanstalk/EC2, Lambda, SQS, API Gateway, S3, SES
\item Setting up development environments and tools, collaboration tools, devops, automated build/test/deploy, CI/CD
\item Comfortable using (and writing) command line tools, bash/shell scripts


\item Experience writing desktop engineering software tools in JavaScript, Node.js, Electron, Octave (Matlab)
...
Volunteer as a programming coach at \href{https://codebar.io}{Codebar} in Bristol
...
Referee: Luke Sartain, CEO. luke@upugo.com \\

Experience designing, deploying and maintaining distributed/microservice architecture in
