...
\item Full stack software engineering in JavaScript, NodeJS, React. Experience designing, building and maintaining entire software systems/platforms including servers, API/backend, databases, frontend, job queue systems
\item AWS; ElasticBeanstalk/EC2, Lambda, SQS, APIgateway, S3, SES.




\item Web and application UI design in JavaScript, HTML5, CSS, React.Js
